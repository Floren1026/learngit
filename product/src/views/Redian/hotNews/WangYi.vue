<template>
    <div class="news">
        <div class="card-title">
            <div class="titleSource" style="display: inline;">网易新闻热点</div>
        </div>
        <div id="mainTitle">
            <ul>
                            ...
                            <div class="content-title">
                                <div class="topicTitle" :title="ns.title">
                                    <span class="content-logo"
                                        style="background: url('/src/assets/img/wangyi.png');"></span>
...
const fetchData = (value) => {
    if (value === "3") {
        axios.get('http://localhost:8011/News/WangYi')
            .then(response => {
        ...
        axios.get('http://localhost:8088/News/WangYiByEmotion', { params: { numLabel: value } })
            .then(response => {
                newsList.newsData = response.data
                // console.log(newsList.newsData)
            })

<template>
    <div class="news">
        <div class="card-title">
            <div class="titleSource" style="display: inline;">新浪新闻热点</div>
        </div>
        <div id>
            <ul>
                        ...
                        <div class="newsBox">
                            <div class="content-title">
                                <div class="topicTitle" :title="ns.title">
                                    <span class="content-logo" style="background: url('/src/assets/img/xinlang.png');"></span>
...
import './hotNews.css'
    ...
    axios.get('http://localhost:8011/News/XinLang')
        .then(response => {
